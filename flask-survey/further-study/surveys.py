...
demographic_survey = Survey(
    "Demographic Survey",
    "Please complete the survey about your experience",
    [
        ...
        Question("Do you have any questions before you complete your purchase?"),   
        Question("What are you using our [product name] for?",
                 ["Business", "Personal use", "Both business and personal use"],
                 allow_text=True),
    ]
)
...
surveys = {
    ...
    "demographic" : demographic_survey
}